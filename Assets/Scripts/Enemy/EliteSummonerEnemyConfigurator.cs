...
namespace CuteIssac.Enemy
{
    ...
    public sealed class EliteSummonerEnemyConfigurator : MonoBehaviour
    {
        [SerializeField] private EliteSummonerEnemyData enemyData;
        [SerializeField] private EnemyController enemyController;
        [SerializeField] private EnemyMovement enemyMovement;
        [SerializeField] private EnemyHealth enemyHealth;
        [SerializeField] private EnemyVisual enemyVisual;

        public EliteSummonerEnemyData EnemyData => enemyData;
